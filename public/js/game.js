(function() {
    ...
    floatsTracker.prototype.process = function(msgs) {
      ...
      if (msgs !== false) {
        ...
        if (msgs[this.last].actions.length - 1 > this.size) {
          ...
          priority = msgs[this.last].priority[this.size];
          time = 15;
          if (priority === 1) time = 30;
          return this.msgs.push(new floatText(object.msg, time, object.x, object.y, this.random_dir()));
        }
      }
    };
  ...
  stoneDraw = function(p5, x, y) {
    p5.fill(49, 79, 79);
    return p5.quad(x + 10, y, x + 19, y + 10, x + 10, y + 19, x, y + 10);
  };
  ...
  Stone = (function(_super) {
    ...
    function Stone(x, y) {
      ...
      this.name = "stone";
      this.limit = 1;
      Stone.__super__.constructor.call(this, this.x, this.y);
    }
  ...
  scenarioList = function() {
    return ["combat", "hand_disability_combat", "leg_disability", "pig_invasion", "hand_disability_gathering", "full_test_boars", "pathfinding", "unpathable_1", "unpathable_2", "terrain_test", "cuttingDown", "crystal_gathering"];
  };
  ...
  stoneQuarry = function(units, map) {
    return map.sketch.create("wall", 10, 10, false);
  };
  ...
  crystal_gathering = function(units, map) {
    var location;
    units.create(new Human(10, 10, "gatherer", 0));
    location = {
      x: 300,
    ...
    return map.generate.create("crystal", 20, 20);
  };
  ...
  ScenarioInitialize = (function() {
    ...
    ScenarioInitialize.prototype.run = function() {
      switch (this.name) {
        ...
        case "crystal_gathering":
          return crystal_gathering(this.units, this.map);
        default:
